...
> **契约真相源**：[`backend/api/routes.md`](../backend/api/routes.md) · [`backend/api/contract-gap.md`](../backend/api/contract-gap.md) ·（对照）`frontend/packages/api/src/mock.ts` · [ADR-013](./adr/ADR-013-agent-os-kernel.md)  
