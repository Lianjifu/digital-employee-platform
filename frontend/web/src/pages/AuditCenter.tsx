  ...
  return (
    <div className="mx-auto min-h-full max-w-[1480px] p-3 sm:p-4 lg:p-5">
      <header className="rounded-lg border border-[var(--border)] bg-[var(--bg)] px-4 py-4 sm:px-5">
        ...
        <nav className="mt-4 flex gap-1 rounded-md bg-[var(--bg-elevated)] p-1">
        ...
        {(tab === 'events' || tab === 'storyline') && (
          <div className="mt-4 flex h-9 items-center gap-2 rounded-md border border-[var(--border)] bg-[var(--bg-elevated)] px-3">
      ...
      {tab === 'events' && (
        <section className="mt-3 overflow-hidden rounded-lg border border-[var(--border)] bg-[var(--bg)]">
          <div className="flex items-center justify-between border-b border-[var(--border)] px-4 py-3">
            <div className="text-sm font-semibold">{t('module.audit.events')}</div>
