        ...
        <div className="skills-header-panel px-4 py-4 sm:px-5">
          ...
          <Tabs
            ...
            items={[
              ...
              { key: 'integration', label: <>技能接入 <Badge tone="purple" className="ml-1">{installed.filter((skill) => skill.kind !== 'skill').length}</Badge></> },
              { key: 'governance', label: <>运行治理 <Badge tone="info" className="ml-1">{installed.length}</Badge></> },
            ]}
          />
        </div>
